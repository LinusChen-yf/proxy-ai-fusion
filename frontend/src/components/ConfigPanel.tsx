...
import { Plus, Edit, Trash2, CheckCircle, Key, Shield, ShieldCheck } from 'lucide-react';
...
export function ConfigPanel() {
  ...
  const handleDelete = async (service: ServiceId, name: string) => {
    if (!confirm(t('config.confirmDelete', { name }))) {
      return;
    }
